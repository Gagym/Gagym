...
<head>
<meta charset="UTF-8">
<title>ClassReportForm.jsp</title>
   ...
   <div id="outer">
      <div id="inner">
         <div class="box">
            ...
            <form action="classreport.action" method="post">
               ...
               <div style="text-align: center;">
                  <button type="submit" class="btn btn-danger" name="repNo" value="${classNo }">신고</button>

                  <button type="button" class="btn btn-info" onclick="location.href='classview.action?classNo=${classNo}'">
                     취소
                  </button>
               </div>
            </form>
